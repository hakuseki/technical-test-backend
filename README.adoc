...
Mikael Andersso Wigander <mikael.andersson.wigander@pm.me>
...
My explanation of my solution on your technical test.
...
I have made the solution light, it could have more error handlers.
...
----
include::{sourcedir}/java/com/playtomic/tests/wallet/routes/WalletRestRoute.java[tags=WalletRestRoute]
----
